...
# Create the figure and a 3 x 2 grid
...
ax1.plot(y0)
ax1.set_title('y = x³', fontsize='x-small')
...
ax3.plot(x2, y2)
ax3.set_title('Exponential Growth', fontsize='x-small')
...
ax4.plot(x3, y31)
ax4.plot(x3, y32)
ax4.set_title('Exponential Functions', fontsize='x-small')
ax4.set_xlabel('x', fontsize='x-small')
ax4.set_ylabel('y', fontsize='x-small')

# Plot 5 — spans both columns
